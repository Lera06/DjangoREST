...
#         content = JSONRenderer().render(data)  # the returned byte string
#         kwargs['content_type'] = 'application/json'
#         super(JSONResponse, self).__init__(content, **kwargs)

# @csrf_exempt
# def toy_list(request):  # gets HttpRequest instance in the request argument
#     if request.method == 'GET':
#         toys = Toy.objects.all()
#         toys_serializer = ToySerializer(toys, many=True)  # All instances must be serialized, not just one
#         return JSONResponse(toys_serializer.data)  # returns HttpResponse instance
#     elif request.method == 'POST':
